...
import { BarChart3, Users, MessageSquare, Settings, Bot, KeyRound, Home, Wrench } from 'lucide-react';
import { useUserStore } from '../../lib/store';
import AgentManagement from './AgentManagement';
import APILibraryManagement from './APILibraryManagement';
import ToolManagement from './ToolManagement';
import { Link } from 'react-router-dom';

type AdminTab = 'analytics' | 'users' | 'support' | 'settings' | 'agents' | 'api-libraries' | 'tools';
